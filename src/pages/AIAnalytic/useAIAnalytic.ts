...
export const useAIAnalytic = () => {
  ...
  const FIELD_MAPPING = useMemo(
    () => ({
      ai_prompt_text: t('ai_prompt_text'),
      ai_prompt_image: t('ai_prompt_image'),
      ai_prompt_sound: t('ai_prompt_sound'),
      ai_prompt_video: t('ai_prompt_video'),
      flow_active: t('_flow_active'),
    }),
    [t],
  )
  /** Có cần call api */
